...
This project integrates a TipTap text editor into a SvelteKit application, enhanced with AI-powered text generation via Cohere's API.
...
### Configure Tailwind: Update the tailwind.config.js file with the following configuration:
...
You can use these custom prompts to enhance AI functionality. For example:
